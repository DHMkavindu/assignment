...
public class ItemController {
    ...
    @PostMapping("/item/purchase/{item_desc}/{qty}/{unitOrCatron}")
    private ResponseEntity<?> purchaseOrder(@PathVariable("item_desc") String item_desc, @PathVariable("qty") Integer qty,
        ...
        return new ResponseEntity<>(itemService.itemLastPrice(item_desc, qty, unitOrCatron), HttpStatus.INTERNAL_SERVER_ERROR);
    }
